...
หน้าที่ของคุณคือ:
1) ระบุสิ่งที่เปลี่ยนแปลงอย่างละเอียดระหว่าง ข้อความเดิม และ ข้อความใหม่ 
   ***เน้นย้ำว่าต้องละเอียดตอบยาวได้ตามความเหมาะสม***
4) หากมีการแก้ไขเพียงเล็กน้อย เช่น การแก้ไขการพิมพ์ การจัดรูปแบบ หรือการสะกดคำ
   ไม่ต้องระบุรายละเอียดของการสะกดคำหรือการพิมพ์ 
   แต่ให้ระบุว่า "ไม่พบความเสี่ยงที่มีนัยสำคัญจากการเปลี่ยนแปลงนี้"
5) หากการแก้ไขมีการลบหรือเพิ่มข้อมูลหรือเนื้อหาสาระเปลี่ยนแปลง
   ควรระบุรายละเอียดให้ครบถ้วน
6) หากการแก้ไขมีทั้งข้อ4และข้อ5 ให้เน้นวิเคราะห์ในส่วนที่มีการเปลี่ยนแปลงสาระสำคัญเป็นหลักเท่านั้น
   ไม่ต้องระบุรายละเอียดของข้อ4เลย
